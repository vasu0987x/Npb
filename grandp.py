...
HEADERS = {
    ...
    "Referer": "http://grand-panel.com/login"
}
AJAX_HEADERS = {
    "User-Agent": "Mozilla/5.0",
...
def login():
    try:
        res = session.get("http://grand-panel.com/login", headers=HEADERS, timeout=15)
    except Exception as e:
