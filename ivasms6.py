...
STARTUP_SMS_LIMIT       = 1    # On first poll: only send THE latest SMS per number
                               # (prevents group spam on bot restart)
...
# Cache: number → range_name  (refreshed every 60s, keeps old data on failure)
